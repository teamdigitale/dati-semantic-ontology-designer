...
export default function edgeHandlesDefault (edgeType: TypesEnum, isReversed: boolean = false) {
  return {
    canConnect: function (sourceNode: NodeSingular, targetNode: NodeSingular) {
      ...
      switch (sourceType) {
        ...
        case TypesEnum.INDIVIDUAL:
          return (targetType === TypesEnum.INDIVIDUAL && edgeType === TypesEnum.OBJECT_PROPERTY) || targetType === TypesEnum.CLASS
