...
export function instanceOfTypesEnum(value: any): boolean {
    for (const key in TypesEnum) {
        if (Object.prototype.hasOwnProperty.call(TypesEnum, key)) {
            if (TypesEnum[key as keyof typeof TypesEnum] === value) {
                return true;
            }
        }
    }
...
export function TypesEnumToJSONTyped(value: any, ignoreDiscriminator: boolean): TypesEnum {
    return value as TypesEnum;
}
